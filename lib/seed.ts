...
const seeds: Seed[] = [
  ...
  {
    id: "bridal-varmala-set",
    imageBase: "red-rose-varmala",
    name: {
      en: "Bridal Varmala Set",
      hi: "दुल्हन वरमाला सेट",
      te: "వధువు వరమాల సెట్",
      ur: "دلہن ورمالا سیٹ",
    },
    description: {
      en: "Includes 2 grand matching garlands and 2 wrist corsages or boutonnieres. Tell us your colours on WhatsApp.",
      hi: "इसमें 2 भव्य एक जैसी मालाएँ और 2 रिस्ट कोर्सेज या बटनहोल फूल शामिल हैं। अपनी पसंद के रंग WhatsApp पर बताएँ।",
      te: "ఇందులో ఒకేలా ఉండే 2 భారీ హారాలు, 2 మణికట్టు పూల కంకణాలు లేదా చొక్కా పూలు ఉంటాయి. మీకు నచ్చిన రంగులను WhatsApp లో చెప్పండి.",
      ur: "اس میں ایک جیسے 2 شاندار ہار اور 2 کلائی کے پھولوں کے کنگن یا کوٹ کے پھول شامل ہیں۔ اپنی پسند کے رنگ واٹس ایپ پر بتائیں۔",
    },
    price: 4999,
    maxPrice: 14999,
    occasions: ["wedding"],
  ...
  },
  {
    ...
    name: {
      en: "Home Pooja Combo",
      hi: "घर की पूजा कॉम्बो",
      te: "ఇంటి పూజ కాంబో",
      ur: "گھر کی پوجا کومبو",
    },
    description: {
      en: "Includes 1 deity garland, 1 door toran and 500 g of loose rose or marigold flowers.",
      hi: "इसमें 1 देवता की माला, 1 द्वार तोरण और 500 ग्राम खुले गुलाब या गेंदे के फूल शामिल हैं।",
      te: "ఇందులో 1 దేవుడి హారం, 1 ద్వార తోరణం, 500 గ్రాముల విడి గులాబీ లేదా బంతి పువ్వులు ఉంటాయి.",
      ur: "اس میں دیوتا کا 1 ہار، دروازے کا 1 توران اور 500 گرام کھلے گلاب یا گیندے کے پھول شامل ہیں۔",
    },
    price: 899,
    maxPrice: 1899,
    occasions: ["pooja"],
  ...
  {
    id: "stage-backdrop-set",
    imageBase: "stage-backdrop",
    name: {
      en: "Stage & Backdrop Set",
      hi: "स्टेज और बैकड्रॉप सेट",
      te: "స్టేజ్ & బ్యాక్‌డ్రాప్ సెట్",
      ur: "اسٹیج اور بیک ڈراپ سیٹ",
    },
    description: {
      en: "Includes a main stage hanging garland and an entrance door toran, made to the size of your stage.",
      hi: "इसमें मुख्य स्टेज की लटकती माला और प्रवेश द्वार का तोरण शामिल है, आपके स्टेज के नाप से बनाया जाता है।",
      te: "ఇందులో ప్రధాన స్టేజ్ వేలాడే హారం, ప్రవేశ ద్వార తోరణం ఉంటాయి, మీ స్టేజ్ కొలతలకు తగినట్టు తయారు చేస్తాము.",
      ur: "اس میں مرکزی اسٹیج کا لٹکتا ہار اور داخلی دروازے کا توران شامل ہیں، جو آپ کے اسٹیج کے ناپ کے مطابق بنائے جاتے ہیں۔",
    },
    price: 6999,
    maxPrice: 15999,
    occasions: ["wedding", "events"],
